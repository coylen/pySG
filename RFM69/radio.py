...
class Radio(object):
    ...
    def _reset_radio(self):
        ...
        self.pi.write(self.rstPin, 1)
        time.sleep(0.3)
        #GPIO.output(self.rstPin, GPIO.LOW)
        self.pi.write(self.rstPin,0)
        time.sleep(0.3)
    ...
    def _init_interrupt(self):
        ...
        bob = self.pi.callback(self.intPin, pigpio.RISING_EDGE, self._interruptHandler)
    ...
    def _interruptHandler(self, pin, level, tick):
        self.intLock = True
        self.sendLock = False
